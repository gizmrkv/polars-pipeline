...
class LightGBM(Transformer):
    def __init__(
        ...
        *,
        ...
        self.y_columns: List[str] | None = None
    ...
    def transform(self, X: FrameType) -> FrameType:
        ...
        if self.booster is None or self.X_columns is None or self.y_columns is None:
        ...
        return pl.from_numpy(pred, schema=self.y_columns)
